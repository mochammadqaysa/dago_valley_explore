...
import 'package:dago_valley_explore/presentation/components/tinyplanet/tiny_planet.dart';
...
class _SiteplanPageState extends State<SiteplanPage>
  ...
  Future<dynamic> _localFile(String imageUrl) {
    ...
    return FutureBuilder<dynamic>(
      ...
      builder: (context, snapshot) {
        ...
        return buildCachedImage(
          file: file,
          assetPath: imageUrl.isNotEmpty ? imageUrl : null,
