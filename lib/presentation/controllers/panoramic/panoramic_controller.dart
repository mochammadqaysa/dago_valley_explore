    ...
    PanoramaData(
      ...
      hotspots: [
        PanoramaHotspot(
          ...
          label: 'Go to Panorama 10 B-5 D-1',
        ),
        PanoramaHotspot(
          latitude: -10,
          longitude: -63.0,
          ...
          label: 'Go to Panorama 10 B-5 A Kamar 1',
        ),
        PanoramaHotspot(
          latitude: -10,
          longitude: -80.0,
          ...
          iconPath: 'assets/gifs/door_circle.gif',
          label: 'Go to Panorama 10 B-5 B Kamar 1',
        ),
        PanoramaHotspot(
          latitude: -10,
          longitude: -97.0,
          ...
          iconPath: 'assets/gifs/door_circle.gif',
          label: 'Go to Panorama 10 B-5 C Toilet 1',
        ),
        PanoramaHotspot(
          latitude: -30,
          longitude: -140.0,
    ...
    PanoramaData(
      ...
      hotspots: [
        ...
        PanoramaHotspot(
          ...
          iconPath: 'assets/gifs/door_circle.gif',
          label: 'Go to Panorama 10 C-Kamar',
        ),
        PanoramaHotspot(
          latitude: -5,
          longitude: -183.0,
          ...
          iconPath: 'assets/gifs/door_circle.gif',
          label: 'Go to Panorama 10 D-Toilet',
        ),
        PanoramaHotspot(
          latitude: 15,
          longitude: 155.0,
